...
Supports: HTML file, Email, Multi-team reports
...
"""
    ...
    html += f"""
    <div class="footer">
        Generated at {report.generated_at.strftime('%Y-%m-%d %H:%M')} | Sprint Health Agent 🤖 | By Sajan Banka
    </div>
</body>
</html>
"""
...
"""
    ...
    html += """
        <div class="footer">
            Sprint Health Agent 🤖 - All Teams Report | By Sajan Banka
        </div>
    </div>
